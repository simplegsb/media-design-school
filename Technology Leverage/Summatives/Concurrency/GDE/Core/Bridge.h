 ...
 *	Each manager should inherit from this class.
 *
 *	@tparam TImplementer	Set to the interface for the concrete implementation
 *							of the bridge.
 *	@tparam iDLL_ID			An integer unique identifier for this interface. @see CREATE_DLL_ID.
 */

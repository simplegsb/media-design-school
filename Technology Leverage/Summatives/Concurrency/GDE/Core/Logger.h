...
namespace GDE
{
	 ...
	 *	@ingroup Core
	 *
	 *	The interface to a log. Implementations may, for example,
	 *	log to screen, file or tty.
	 */
 ...
 *	@ingroup Core
 *
 *	The DbgSPrint Macro will typically send output to the screen, refresed every frame.
 */

 ...
 *	@param strBuffer	The string buffer to accept the string - must be at least 5 chars.
 */
...
#else
# ifdef _PS2_
#  define CREATE_COMP_DATE_TIME_STRING() "DATE AND TIME UNKNOWN"
# else
#  define CREATE_COMP_DATE_TIME_STRING() __TIMESTAMP__
# endif
#endif
...
namespace GDE
{
	...
	public:
		...
		bool operator == ( const CLibraryVersion& Other ) const
		{
			return GetComparableVersion() == Other.GetComparableVersion();
		}
		...
		UINT32		GetComparableVersion( void ) const
		{
			return (m_uMajorVersion<<16)+(m_uMinorVersion<<8)+(m_uPointVersion);
		}
	protected:
	...
	public:
		...
		const CLibraryVersion&	GetVersion( void ) const { return m_Version; }
	protected:
	...
	///////////////////////////////////////////////////////////////////////////
	// Inline implementation so only this file (and types.h) need including.

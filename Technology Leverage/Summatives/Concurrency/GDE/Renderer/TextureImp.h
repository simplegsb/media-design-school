/**
 *	@file GDE\Renderer\TextureImp.h
 *	@brief 
 *	
 *	Copyright()
...
namespace GDE
{
	 ...
	 *	@ingroup Renderer
	 *
	 *	The interface for the concrete implementation of the CTexture class.
 	 */
	class ITextureImp_1_0_0 : public IResource
	{
	public:
		/**
	...
	/**
	 *	The final (latest version) of the texture interface.
	 *	Is an inherited class rather than a typedef so it can be forward declared.
	 */
	class ITextureImp : public ITextureImp_1_0_0
	{

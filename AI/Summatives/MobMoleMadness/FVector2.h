/**
 *	@file MobMoleMadness\FVector2.h
 *	@brief 
 *	
 *	Copyright()
...
//		return *this;
	...
	inline FLOAT32 AngleTo( CFVec2Arg arg ) const
	{
		return acos(DotProduct(arg) / (Magnitude() * arg.Magnitude()));
	}

	inline FLOAT32 CrossProduct( CFVec2Arg arg ) const
	{
